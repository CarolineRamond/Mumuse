...
const rasterSources = {
	"57fc94951af5a68c45e6811f-source": {
		type: "raster",
		tiles: ['https://citesticonem.blob.core.windows.net/rastertile/57fc94951af5a68c45e6811f/{z}/{x}/{y}'],
		tileSize: 128,
		minzoom: 9,
		maxzoom: 24,
		bounds: [36.30007802124635, 33.50492356207882, 36.30869103984678, 33.51256955798446],
	...
	"57fc94951af5a68c45e68120-source": {
		type: "raster",
		tiles: ['https://citesticonem.blob.core.windows.net/rastertile/57fc94951af5a68c45e68120/{z}/{x}/{y}'],
		tileSize: 256,
		minzoom: 10,
		maxzoom: 22,
		bounds: [43.22349441788488, 36.503782031163446, 43.233221640104894, 36.51518534690497],
